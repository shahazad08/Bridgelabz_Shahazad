from Utilities.datastructure import Operations, Stack
import datetime
import json
...
class Person:
    try:
        ...
        def sell_share(self, index, name):
            ...
            # t=str(s.push(("Buy",choice,dt)))
            # print(t)
            stack.push(("Sold", self.stock_jf["Stock Report"][choice]["Stock Name"], "Number of shares : ", sell_share))
            with open("/home/admin1/PycharmProjects/BridgeLabzDemo/JSON/stack_transaction.txt", "a")as txt:
...
# """
# ******************************************************************************
# * Purpose:  Commercial Data Processing in a Stack
# *
